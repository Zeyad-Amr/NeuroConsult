class HL7Parser {
    static parseHL7ToJSON(hl7Message: string): any {
    ...
    static convertJSONToHL7(json: any): string {
        let hl7Message = '';
    ...
    static parsePID(fields: string[]): any {
        const pidJson: any = {};
        pidJson['id'] = fields[2] || '';
    ...
    static parseMedications(fields: string[]): any {
        return {
            id: fields[2],
            medication: fields[3],
            dose: fields[4],
    ...
    static parseAllergies(fields: string[]): any {
        return {
            id: fields[2],
            name: fields[3]
        };
    ...
    static parseDiagnosis(fields: string[]): any {
        return {
            id: fields[2],
            name: fields[3]
        };
    ...
    static parseLabs(fields: string[]): any {
        return {
            id: fields[2],
            name: fields[3],
            result: fields[4]
    ...
    static parseImaging(fields: string[]): any {
        return {
            id: fields[2],
            name: fields[3],
            result: fields[4]
    ...
    static parseConsultationRequests(fields: string[]): any {
        return {
            id: fields[2],
            complaint: fields[3]
        };
